...
const { createProduct, loadaddProduct, loadAllProducts, deleteProduct, loadUpdateProduct, updateProduct } = require('../controller/productCtrl')
...
const { getAllUsers } = require('../controller/userCtrl')
